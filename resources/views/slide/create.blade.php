                ...
                <form action="{{route('slide.store')}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" name="titulo" id="titulo" placeholder="titulo da imagem" value="{{ old('titulo')}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="descricao">Descriçao</label>
                        <div class="form-control-wrap">
                            <textarea class="form-control no-resize" name="descricao" id="descricao">{{ old('descricao')}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
